...
export default function Navbar() {
    return (
        <div className="npv" id="npv">
            <header className="header header_update" id="header_update" >
                <div className="container f-center-jcsb">
                    <div className="header-wrap f-center">
                        <div className="header-logo lgo " >
                            <img src={Logo} alt="" className="a" id="header-logo" />
                        </div>
                    ...
                    <div className="header-control f-center">
                        <a className="header-link main-btn" id="connect" style={{ cursor: 'pointer' }}  >
                            Connect Wallet
                        </a>
