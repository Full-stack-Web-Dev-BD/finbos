                    ...
                    <div className="credits-wrapper f-center-jcsb">
                        ...
                        <ul className="credits-list f-center">
                            <li className="credits-list__item">
                                <a href="https://bnbmoney.app/static/media/wp.4687c56a.pdf" className="credits-list__link main-btn" target="_blank">
                                    Whitepaper
                                </a>
                            </li>
                            <li className="credits-list__item">
                            ...
                            <li className="credits-list__item">
                                <a href="https://bnbmoney.app/bnbmoney.app.pdf" className="credits-list__link main-btn">
                                    Audit
                                </a>
                            </li>
                            <li className="credits-list__item">
                                <a href="https://t.me/bnbmoneyapp" className="credits-list__link main-btn">
                                    Chat
                                </a>
                            </li>
                        </ul>
