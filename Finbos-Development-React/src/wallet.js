...
export const getWalletAddressOrConnect = async (shouldSwitchNetwork, refresh) => {
    console.log("getWalletAddressOrConnect called ......")
    const currentAddress = async () => {
        ...
        try {
            console.log("try...")
            console.log((await provider?.request({ method: 'eth_requestAccounts' }))[0])
    ...
    // }
    console.log("current address calling ... ", await currentAddress())
